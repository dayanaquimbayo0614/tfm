...
X_train1, y_train1, X_test1, y_test1 = train_test(data_ibex)
...
X_train_base1, y_train_base1, X_test_base1, y_test_base1 = train_test_base(data_ibex)
...
data_total_transform = tranformacion_por_indice(full_precios)
