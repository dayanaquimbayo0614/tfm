...
def fechas_train_test(data):
    ...
    X_train_total = train_total.drop(['target_5dias', 'D1_ward', 'PAM', 'D2_complete', 'sector'], axis = 1)
    y_train_total = train_total.loc[:,'target_5dias']
    X_test_total = test_total.drop(['target_5dias',  'D1_ward', 'PAM', 'D2_complete', 'sector'], axis = 1)
    y_test_total = test_total.loc[:,'target_5dias']
    return X_train_total, X_test_total, y_train_total, y_test_total
...
X_train_total, X_test_total, y_train_total, y_test_total = fechas_train_test(data_ibex)
###################### MODELOS RANDOM FOREST #####################################

def empresas(ind):
    full_precios_emp = data_ibex[data_ibex.indice == ind]
    X_train_emp, y_train_emp, X_test_emp, y_test_emp = train_test(full_precios_emp)
    X_train_total_emp, X_test_total_emp, y_train_total_emp, y_test_total_emp = fechas_train_test(full_precios_emp)
    return X_train_emp, y_train_emp, X_test_emp, y_test_emp, X_train_total_emp, X_test_total_emp, y_train_total_emp, y_test_total_emp
...
X_train_c1, y_train_c1, X_test_c1, y_test_c1 = train_test(full_precios_clust1)
X_train_total_c1, X_test_total_c1, y_train_total_c1, y_test_total_c1 = fechas_train_test(full_precios_clust1)


full_precios_clust2 = data_ibex[data_ibex.D1_ward == 2]
X_train_c2, y_train_c2, X_test_c2, y_test_c2 = train_test(full_precios_clust2)
X_train_total_c2, X_test_total_c2, y_train_total_c2, y_test_total_c2 = fechas_train_test(full_precios_clust2)
