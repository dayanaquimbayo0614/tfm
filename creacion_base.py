...
def fechas_train_test(data):
    ...
    X_train_total = train_total.drop(['target_5dias', 'D1_ward', 'PAM', 'D2_complete','indice', 'sector'], axis = 1)
    y_train_total = train_total.loc[:,'target_5dias']
    X_test_total = test_total.drop(['target_5dias',  'D1_ward', 'PAM', 'D2_complete', 'indice', 'sector'], axis = 1)
